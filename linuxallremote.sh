...
while true; do
	...
	echo -ne " 1113. eteran/edb-debugger\n"
	echo "$SEP"
	echo "DECRYPTING"
	...
	"2353")
		...
		select DIM in "techantidote/aircrack" "frapsoft/aircrack-ng" "caffix/amass" "grugnog/amass" "nodyd/amass" "simonthomas/armitage" "eivantsov/arp-scan" "ganboing/arp-scan" "bannsec/autopsy" "bannsec/beef" "ilyaglow/beef" "janes/beef" "phocean/beef" "hypnza/dirbuster" "pemcconnell/docker-burpsuite" "dizcza/docker-hashcat" "pypi/enum" "docker4x/enum-azure" "aoighost/gobuster" "devalias/gobuster" "kodisha/gobuster" "vulhub/gobuster" "adamoss/john-the-ripper" "phocean/john_the_ripper_jumbo" "naik/kali-armitage" "fcch/kali-console" "metasploitframework/metasploit-framework" "online2311/mitmf" "instrumentisto/nmap" "szalek/pentest-tools" "tomsteele/recon-ng" "kfaughnan/smbclient" "siuyin/smbclient" "ilyaglow/sqlmap" "jamesmstone/sqlmap" "m4n3dw0lf/sqlmap" "paoloo/sqlmap" "sagikazarmark/sqlmap" "secretsquirrel/the-backdoor-factory" "opennsm/tshark" "sflow/tshark" "toendeavour/tshark" "dominicbreuker/wfuzz" "hypnza/wfuzz" "ilyaglow/wfuzz" "linuxserver/wireshark" "ffeldhaus/wireshark" "manell/wireshark" "wpscanteam/wpscan" "owasp/zap2docker-bare" "owasp/zap2docker-live" "owasp/zap2docker-stable"
		do
			if [[ "$DIM" != "" ]];
			then
				echo "Digit a tag"
