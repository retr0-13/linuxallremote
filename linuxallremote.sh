...
while true; do
	...
	echo -ne " 2448. ricardojoserf/adfsbrute\t\t\t1231. NetSPI/goddi\t\t\t\t1242. MartinIngesen/gpocrack\n"
	echo "$SEP"
	echo "ACQUISITION"
	...
	echo -ne " 2409. asad1996172/Obfuscation-Detection\t\t\t\t\t\t2441. unipacker/unipacker\t\t\t1253. anchore/grype\n"
	...
	echo -ne " 940. 0xPoly/Centry\t\t\t\t1208. GasparVardanyan/GCrypt\n"
	echo "$SEP"
	echo "APACHE"
	...
	echo -ne " 2313. cribdragg3r/Alaris\t\t\t\t1206. byt3bl33d3r/gcat\t\t\t\t1229. razc411/GoBD\n"
	echo "$SEP"
	echo "BLUETOOTH"
	...
	echo "$SEP"
	echo "BOT - AI"
	echo -ne " 445. evilsocket/kitsune\t\t\t1144. BishopFox/eyeballer\n"
	echo "$SEP"
	echo "BOTNET"
	...
	echo -ne " 980. wpscanteam/CMSScanner\t\t\t984. Intrinsec/comission\t\t\t\t1086. droope/droopescan\n"
	echo "$SEP"
	echo "CORS"
	...
	echo -ne " 1230. OJ/gobuster\t\t\t\t2498. blacklanternsecurity/MANSPIDER\t\t\t\t1268. hakluke/hakrawler\n"
	echo "$SEP"
	echo "CSRF - XSRF - SSRF"
	...
	echo -ne " 926. Konloch/bytecode-viewer\t\t\t1030. 0xd4d/de4dot\t\t\t\t\t1106. iGio90/Dwarf\n"
	echo -ne " 1113. eteran/edb-debugger\t\t\t1164. fesh0r/fernflower\t\t\t\t\t1209. cs01/gdbgui\n"
	echo "$SEP"
	echo "DECRYPTING"
	...
	echo -ne " 342. vivisect/vivisect\t\t\t\t791. MITRECND/abcd\t\t\t\t\t948. 0xbc/chiasm-shell\n"
	echo -ne " 1055. gdabah/distorm\t\t\t\t948. 0xbc/chiasm-shell\n"
	echo "$SEP"
	echo "DISCOVERING"
	...
	echo -ne " 1165. stealth/fernmelder\t\t\t\t1173. Edu4rdSHL/findomain\t\t\t\t\t1190. kirei/fpdns\n"
	echo -ne " 1235. zombiesam/googlesub\t\t\t\t1269. hakluke/hakrevdns\n"
	echo "$SEP"
	echo "DOCKER"
	...
	echo -ne " 1142. bwall/ExtractHosts\t\t\t1196. Nightbringer21/fridump\n"
	echo "$SEP"
	echo "EDITOR"
	...
	echo "$SEP"
	echo "FACEBOOK"
	echo -ne " 1148. tomoneill19/facebookOSINT\t\t\t1149. pun1sh3r/facebot\t\t\t1150. PowerScript/facebrok\n"
	echo -ne " 1151. emerinohdz/FaceBrute\t\t\t1159. chinoogawa/fbht\n"
	echo -ne " 1160. xHak9x/fbi\t\t\t1161. guelfoweb/fbid\n"
	echo "$SEP"
	echo "FILE - SYSTEM"
	...
	echo -ne " 1168. henshin/filebuster\t\t\t2468. intrudir/403fuzzer\t\t\t\t1189. Owlz/formatStringExploiter\n"
	echo -ne " 1201. mdiazcl/fuzzbunch-debian\t\t\t1252. trailofbits/grr\n"
	echo "$SEP"
	...
	echo -ne " 2422. michenriksen/gitrob\t\t\t1216. bahamas10/node-git-dump\t\t\t1217. tillson/git-hound\n"
	...
	echo "$SEP"
	echo "GOPHER"
	echo -ne " 1238. tarunkant/Gopherus\n"
	echo "$SEP"
	echo "GRAPHQL"
	echo -ne " 1249. swisskyrepo/GraphQLmap\n"
	echo "$SEP"
	echo "GTFO"
	echo -ne " 1255. mzfr/gtfo\t\t\t\t1256. nccgroup/GTFOBLookup\n"
	echo "$SEP"
	echo "GVM"
	echo -ne " 1251. greenbone/gsa\t\t\t\t1257. greenbone/gvmd\n"
	echo "$SEP"
	echo "HARDWARE"
	...
	echo "$SEP"
	echo "HTTP - HTTP/2"
	echo -ne " 1260. summerwind/h2spec\n"
	echo "$SEP"
	echo "IIS"
	...
	echo -ne " 864. ChiChou/bagbak\t\t\t\t2286. seemoo-lab/toothpicker\t\t\t\t2308. RealityNet/ios_triage\n"
	echo -ne " 2309. abrignoni/iLEAPP\t\t\t\t1194. AloneMonkey/frida-ios-dump\n"
	echo "$SEP"
	echo "IoT"
	...
	echo -ne " 2396. Shopify/kubeaudit\t\t\t\t2397. controlplaneio/kubesec\t\t\t2398. aquasecurity/kube-bench\n"
	echo "$SEP"
	echo "LDAP"
	...
	echo -ne " 2383. andrew-d/static-binaries/linux/arm\t\t2400. r3curs1v3-pr0xy/vajra\t\t\t1125. gteissier/erl-matter\n"
	...
	echo -ne " 1154. fireeye/flare-fakenet-ng\t\t\t1185. 7h3rAm/flowinspect\t\t\t\t1204. michaeltelford/gatecrasher\n"
	echo -ne " 1266. haka-security/haka\n"
	echo "$SEP"
	echo "MOBILE"
	...
	echo -ne " 2340. Pinperepette/GeoTweet\t\t\t2343. UndeadSec/EvilURL\t\t\t\t\t2460. ultrasecurity/Storm-Breaker\n"
	echo -ne " 1239. gophish/gophish\n"
	echo "$SEP"
	echo "PHP"
	...
	echo "$SEP"
	echo "RADIO"
	echo -ne " 1244. bistromath/gr-air-modes\t\t\t1245. ptrkrysik/gr-gsm\t\t\t1246. drmpeg/gr-paint\n"
	echo -ne " 1265. mossmann/hackrf\n"
	echo "$SEP"
	echo "RAINBOW TABLE"
	...
	echo -ne " 2433. eslam3kl/3klector\t\t\t2434. eslam3kl/Explorer\t\t\t\t\t1158. devanshbatham/FavFreak\n"
	echo "$SEP"
	echo "REDIS"
	echo -ne " 759. Avinash-acid/Redis-Server-Exploit\t\t\t1264. Ridter/hackredis\n"
	echo "$SEP"
	echo "REST"
	...
	echo -ne " 2408. mentebinaria/retoolkit\t\t\t1179. rampageX/firmware-mod-kit\t\t\t1193. OALabs/frida-extract\n"
	echo -ne " 1210. hugsy/gef\n"
	echo "$SEP"
	echo "REVSHELL"
	...
	echo "$SEP"
	echo "RSA"
	echo -ne " 57. Ganapati/RsaCtfTool\t\t\t69. zweisamkeit/RSHack\t\t\t79. pablocelayes/rsa-wiener-attack\n"
	echo "$SEP"
	echo "S7"
	...
	echo -ne " 235. shodansploit/shodansploit\t\t\t236. ninj4c0d3r/ShodanCli\t\t\t\t2246. souravbaghz/RadareEye\n"
	...
	echo -ne " 2412. urbanadventurer/Android-PIN-Bruteforce\t\t\t2450. modded-ubuntu/modded-ubuntu\n"
	echo "$SEP"
	echo "TFTP"
	echo -ne " 719. nullsecuritynet/tftp-fuzz\t\t\t1199. RubenRocha/ftpscout\n"
	echo "$SEP"
	echo "TLS"
	...
	echo -ne " 986. patpadgett/corkscrew\t\t\t1010. chokepoint/CryptHook\t\t\t1176. BishopFox/firecat\n"
	echo -ne " 1191. stealth/fraud-bridge\n"
	echo "$SEP"
	echo "UPNP"
	...
	echo -ne " 2465. litneet64/etherblob-explorer\t\t1212. KarmaHostage/gethspoit\n"
	echo "$SEP"
	echo "VOIP"
	...
	echo "$SEP"
	echo "?"
	echo -ne " 36. SigPloiter/HLR-Lookups\t\t\t37. i3visio/osrframework\t\t\t\t2354. py2exe/py2exe\n"
