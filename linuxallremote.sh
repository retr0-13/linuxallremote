...
while true; do
	...
	echo -ne " 223. unicorn-engine/unicorn\t\t\t848. icsharpcode/AvaloniaILSpy\n"
	echo "$SEP"
	echo "DECRYPTING"
	...
	echo -ne " 824. tokyoneon/Armor\t\t\t\t869. Bashfuscator/Bashfuscator\n"
	echo "$SEP"
	echo "EXCHANGE"
	...
	echo -ne " 781. E4rr0r4/XGDork\t\t\t\t854. aliasrobotics/aztarna\n"
	echo "$SEP"
	echo "FTP"
	...
	echo -ne " 844. Tib3rius/AutoRecon\n"
	echo "$SEP"
	echo "REDIS"
	...
	echo -ne " 835. AlisamTechnology/ATSCAN-V3.1\n"
	echo "$SEP"
	echo "SHELL"
