...
while true; do
	...
	echo -ne " 631. Anon-Exploiter/SiteBroker\n"
	echo "$SEP"
	echo "GIT - REPOS"
	...
	echo -ne " 601. UnaPibaGeek/ctfr\t\t\t\t607. thewhiteh4t/seeker\n"
	echo "$SEP"
	echo "REVERSING"
	...
	"598")
		...
		if [[ "$URL" != "" ]];
		then
			for FILE in "wp-includes/certificates/ca-bundle.crt" "robots.txt" ".htaccess" "condig.php" "sitemap.xml" "phpinfo.php" "wp-config.php"; do wget "$URL""/""$FILE"; done
		fi
	;;
	"599")
