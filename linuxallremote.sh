...
while true; do
	...
	echo -ne " 1170. keithjjones/fileintel\n"
	echo "$SEP"
	echo "ANDROID - APK"
	...
	echo -ne " 1165. stealth/fernmelder\t\t\t\t1173. Edu4rdSHL/findomain\n"
	echo "$SEP"
	echo "DOCKER"
	...
	echo -ne " 1142. bwall/ExtractHosts\n"
	echo "$SEP"
	echo "EDITOR"
	...
	echo -ne " 2445. ra1nb0rn/avain\t\t\t\t1162. chrispetrou/FDsploit\n"
	echo -ne " 1174. 1N3/findsploit\n"
	echo "$SEP"
	echo "MITM"
	...
	echo -ne " 1154. fireeye/flare-fakenet-ng\n"
	echo "$SEP"
	echo "MOBILE"
	...
	echo -ne " 1145. ChrisTruncer/EyeWitness\t\t\t2464. nim-lang/choosenim/vaf\n"
	echo "$SEP"
	echo "WEBDAV"
	...
	echo -ne " 814. lewangbtcc/anti-XSS\t\t\t1069. whitel1st/docem\n"
	echo "$SEP"
	echo "ZIP"
	...
	echo -ne " 1171. subinacls/Filibuster\n"
	echo "$SEP"
