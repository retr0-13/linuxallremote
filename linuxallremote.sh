...
while true; do
	...
	echo -ne " 1170. keithjjones/fileintel\t\t\t1178. craigz28/firmwalker\n"
	...
	echo -ne " 1200. lostincynicism/FuzzAP\n"
	echo "$SEP"
	echo "EXCHANGE"
	...
	echo -ne " 1201. mdiazcl/fuzzbunch-debian\n"
	echo "$SEP"
	...
	echo -ne " 1187. byt3smith/Forager\n"
	echo "$SEP"
	echo "GIT - REPOS"
