...
PYPAK="0trace 3proxy 3proxy-win32 42zip acccheck ace admid-pack adminpagefinder admsnmp aesfix aeskeyfind aespipe afflib afpfs-ng against aiengine aimage air airflood airgraph-ng airoscript airpwn allthevhosts american-fuzzy-lop androguard androick android-apktool android-ndk android-sdk-platform-tools android-sdk android-udev-rules androidsniffer anontwi aphopper apnbf arachni arduino argus argus-clients armitage arp-scan arpalert arpantispoofer arpoison arpon arpwner artillery asleap asp-audit athena-ssl-scanner atstaketools auto-xor-decryptor autopsy azazel b2sum backcookie backdoor-factory backfuzz balbuzard bamf-framework basedomainname batman-adv bbqsql bdfproxy bed beef beholder beleth bfbtester bgp-md5crack bing-ip2hosts bing-lfi-rfi binwalk binwally bios_memimage birp bittwist bkhive blackarch-menus blackhash bletchley blindelephant blindsql bluebox-ng bluebugger bluelog bluepot blueprint blueranger bluesnarfer bmap-tools bob-the-butcher bokken bowcaster braa braces browser-fuzzer brutessh brutus bsdiff bsqlbf bss bt_audit btcrack btscanner bulk-extractor bully bunny burpsuite buttinsky bvi cadaver canari cansina capstone carwhisperer casefile cdpsnarf cecster centry cewl cflow chaosmap chaosreader chapcrack check-weak-dh-ssh checkiban checkpwd checksec chiron chkrootkit chntpw chownat chrome-decode chromefreak cidr2range cintruder ciphertest cirt-fuzzer cisco-auditing-tool cisco-global-exploiter cisco-ocs cisco-router-config cisco-scanner cisco-torch cisco5crack cisco7crack ciscos climber clusterd cmospwd cms-explorer cms-few codetective complemento conpot conscan cookie-cadger cowpatty cpfinder cppcheck cpptest crackhor crackmapexec crackle crackserver create-ap creddump creds creepy crunch cryptcat crypthook cryptonark csrftester ctunnel cuckoo cupp cutycapt cvechecker cymothoa darkbing darkd0rk3r darkjumper darkmysqli darkstat davoset davtest dbd dbpwaudit dc3dd dcfldd ddrescue deblaze delldrac depant device-pharmer dex2jar dff-scanner dhcdrop dhcpig dinouml dirb dirbuster directorytraversalscan dirs3arch dirscanner dislocker dissector dissy dizzy dmitry dnmap dns-spoof dns2geoip dns2tcp dnsa dnsbf dnsbrute dnschef dnsdrdos dnsenum dnsgoblin dnsmap dnspredict dnsrecon dnsspider dnstracer dnsutils dnswalk domain-analyzer doona dotdotpwn dpeparser dpscan dradis driftnet dripper dscanner dsd dsniff dumb0 dump1090 dumpacl dumpzilla eapmd5pass easy-creds easyfuzzer eazy edb eindeutig elettra elettra-gui elite-proxy-finder enabler encodeshellcode ent enum-shares enum4linux enumiax enyelkm epicwebhoneypot erase-registrations etherape ettercap evilgrade evilmaid exiv2 exploit-db extracthosts extundelete eyepwn eyewitness facebot facebrute fakeap fakedns fakemail fakenetbios fang fbht fcrackzip fern-wifi-cracker fernmelder fgscanner fhttp fierce fiked filibuster fimap findmyhash firewalk firmware-mod-kit firstexecution fl0p flare flasm flawfinder flowinspect flunym0us foremost fpdns fping fport fraud-bridge freeipmi freeradius frisbeelite fs-nyarl fsnoop fstealer ftester ftp-fuzz ftp-scanner ftp-spider ftpmap fusil fuzzap fuzzball2 fuzzdb fuzzdiff fuzztalk g72x++ galleta gdb genlist geoedge geoip geoipgen getsids gggooglescan ghettotooth ghost-phisher ghost-py giskismet gnuradio gnutls2 goldeneye golismero goodork goofile goog-mail googlesub gooscan gqrx grabber grepforrfi grokevt gtalk-decode gtp-scan guymager gwcheck gwtenum hackersh halberd halcyon hamster handle hasere hash-identifier hashcat hashcat-utils hasher hashid hashpump hashtag haystack hbad hcraft hdcp-genkey hdmi-sniff heartbleed-honeypot hex2bin hexinject hexorbase hharp hidattack honeyd honssh hookanalyser host-extract hostbox-ssh hotpatch hotspotter hpfeeds hping hqlmap htexploit htrosbif htshells http-enum http-fuzz http-put http-traceroute httpbog httpforge httping httprint httprint-win32 httpry httpsniff httpsscanner httptunnel hulk hwk hydra hyenae hyperion iaxflood iaxscan ibrute icmpquery icmptx iheartxor ike-scan ikecrack ikeprobe ikeprober ilty imagejs inception indxparse inetsim infip inguma intercepter-ng interrogate intersect intrace inundator inviteflood iodine iosforensic ip-https-tools ipaudit ipba2 ipdecap iphoneanalyzer ipscan iputils ipv6toolkit ircsnapshot irpas isr-form jad javasnoop jboss-autopwn jbrofuzz jbrute jd-gui jhead jigsaw jnetmap john johnny jomplug joomlascan joomscan js-beautify jsql junkie jwscan jynx2 kalibrate-rtl katsnoop kautilya keimpx khc killerbee kippo kismet kismet-earth kismet2earth klogger kolkata kraken laf lanmap2 lans latd laudanum lbd lbmap ldapenum leo leroy-jenkins levye lfi-autopwn lfi-exploiter lfi-fuzzploit lfi-scanner lfi-sploiter lfimap lft libdisasm libpst liffy linenum linux-exploit-suggester list-urls littleblackbox lodowep logkeys loki lorcon lotophagi lsrtunnel luksipc lynis mac-robber macchanger maclookup magicrescue magictree make-pdf makepasswd malheur maligno malmon maltego maltrieve malware-check-tool malwareanalyser malwaredetect malwasm marc4dasm maskprocessor masscan mat matahari mausezahn mbenum mboxgrep md5deep mdbtools mdcrack mdk3 mdns-scan medusa melkor memdump memfetch metacoretex metagoofil metasploit metoscan mfcuk mfoc mfsniffer mibble middler minimysqlator miranda-upnp miredo missidentify missionplanner mitmap mitmer mitmf mitmproxy mkbrutus mobiusft modscan moloch monocle morxbrute morxcrack mp3nema mptcp mptcp-abuse ms-sys mssqlscan msvpwn mtr multiinjector multimac multitun mutator mysql2sqlite nacker nbnspoof nbtenum nbtool nbtscan ncpfs ncrack nemesis netactview netbios-share-scanner netcommander netcon netdiscover netmap netmask netreconn netscan netsed netsniff-ng netzob nfcutils nfex nfspy nfsshell ngrep nield nikto nimbostratus nipper nishang nkiller2 nmap nmbscan nomorexor notspikefile nsdtool nsec3walker ntds-decode o-saft oat obexstress obfsproxy oclhashcat ocs ohrwurm ollydbg onesixtyone onionshare openstego opensvp openvas-cli openvas-libraries openvas-manager openvas-scanner ophcrack orakelcrackert origami oscanner ostinato osueta owabf owasp-bywaf owtf p0f pack packerid packet-o-matic packeth packit pacumen padbuster paketto panoptic paros parsero pasco passcracking passe-partout passivedns pastenum patator pathod pblind pcapsipdump pcredz pdf-parser pdfbook-analyzer pdfcrack pdfid pdfresurrect pdgmail peach peda peepdf pentbox perl-image-exiftool perl-tftp pev pextractor pgdbf phoss php-mt-seed php-rfi-payload-decoder php-vulnerability-hunter phpstress phrasendrescher pipal pirana plcscan plecost plown pmcma pnscan pompem portspoof posttester powerfuzzer powersploit praeda prometheus propecia protos-sip proxychains-ng proxycheck proxyp proxyscan proxytunnel pscan pshitt pstoreview ptunnel pwd-hash pwdump pwnat pwntools pyew pyfiscan pyinstaller pyminifakedns pyrasite pyrit pytacle pytbull python-utidylib python2-binaryornot python2-yara quickrecon radamsa radare2 radiography rainbowcrack rarcrack ratproxy rawr rcracki-mt rdesktop-brute reaver rebind recon-ng recoverjpeg recstudio redfang redirectpoison regeorg reglookup relay-scanner replayproxy responder rfcat rfdump rfidiot rfidtool ridenum rifiuti2 rinetd ripdc rkhunter rlogin-scanner rootbrute ropeadope ropeme ropgadget ropper rpdscan rrs rsakeyfind rsmangler rtlsdr-scanner rtp-flood rtpbreak rubilyn ruby-msgpack ruby-ronin ruby-ronin-support ruby-uri-query_params rww-attack safecopy sakis3g sambascan samdump2 samydeluxe sandy sasm sb0x sbd scalpel scanmem scanssh scapy schnappi-dhcp scout2 scrapy scrounge-ntfs sctpscan seat secscan secure-delete sees sergio-proxy sessionlist set sfuzz shellcodecs shellme shellnoob shortfuzzy sidguesser siege silk simple-ducky simple-lan-scan sinfp siparmyknife sipcrack sipp sipsak sipscan sipshock sipvicious skipfish skyjack skype-dump skypefreak sleuthkit slowhttptest slowloris smali smartphone-pentest-framework smbbf smbexec smbrelay smtp-fuzz smtp-user-enum smtp-vrfy smtpmap smtpscan sn00p sniffjoke snmp-fuzzer snmpattack snmpcheck snmpenum snmpscan snoopy-ng snort snow snscan socat soot spade sparty spectools speedpwn spiderfoot spiderpig-pdffuzzer spiga spike spike-proxy spiped spipscan splint sploitctl sploitego spooftooph sps sqid sqlbrute sqlmap sqlninja sqlpat sqlping sqlsus ssh-privkey-crack sshatter sshscan sshtrix sshuttle ssl-hostname-resolver ssl-phuck3r sslcat sslcaudit ssldump sslh sslmap sslnuke sslscan sslsniff sslsplit sslstrip sslyze stackflow starttls-mitm statsprocessor steghide stompy storm-ring stunnel subdomainer subterfuge sucrack sulley superscan suricata svn-extractor swaks swfintruder synflood synner synscan sysdig sysinternals-suite t50 taof tbear tcgetkey tcpcontrol-fuzzer tcpdump tcpextract tcpflow tcpick tcpjunk tcpreplay tcptraceroute tcpwatch tcpxtract teardown tekdefense-automater termineter tftp-bruteforce tftp-fuzz tftp-proxy thc-ipv6 thc-keyfinder thc-pptp-bruter thc-smartbrute thc-ssl-dos theharvester themole tiger tilt timegen tinc tinyproxy tlsenum tlspretense tlssled tnscmd topera tor tor-autocircuit tor-browser-en torshammer torsocks tpcat traceroute trid trinity trixd00r truecrack truecrypt tsh tsh-sctp tuxcut twofi u3-pwn uatester ubertooth ubitack udis86 udptunnel uefi-firmware-parser ufo-wardriving ufonet umap umit unhide unicorn unicornscan uniofuzz uniscan unix-privesc-check unsecure upnpscan upx urlcrazy urldigger username-anarchy usernamer uw-loveimap uw-offish uw-udpscan uw-zone v3n0m valgrind vanguard vbrute vega veil vfeed vidalia videosnarf vinetto viper viproy-voipkit vivisect vnak vnc-bypauth vncrack voiper voiphopper voipong volatility vstt vulscan w3af waffit wafp wapiti wavemon web-soul webacoo webenum webhandler webpwn3r webrute webscarab webshag webshells webslayer websockify webspa websploit weevely wepbuster wfuzz whatweb wi-feye wifi-honey wifi-monitor wificurse wifijammer wifiphisher wifitap wifite wig wikigen winexe winfo wireless-ids wireshark-cli wireshark-gtk wirouter-keyrec witchxtool wlan2eth wmat wnmap wol-e wordpot wpbf wpscan ws-attacker wsfuzzer wyd x-scan xcavator xf86-video-qxl-git xorbruteforcer xorsearch xortool xplico xprobe2 xspy xsser xssless xsss xssscan xsssniper xssya yara ycrawler yersinia yinjector zackattack zaproxy zarp zerowine zmap zulu zykeys zzuf"
RUPAK="apscanner apullo arp_scan brakeman bscan cms_scanner dawnscanner dockscan domains_scanner DrupalScan fast_port_scanner google-cloud-web_security_scanner hacker-gems ham http_scanner network_scanner password_crack portfinder portscanner recog rpc-mapper ruby_wifi_scanner scanny ScanSSL smb-client snmpscan ssh-exec ssh_scan ssl_scan ssl_scanner w3map wordstress wpscan XSpear xss zola"
...
while true; do
	...
	echo -ne " 2291. tomdev/teh_s3_bucketeers\n"
	echo "$SEP"
	echo "AZURE"
	...
	echo -ne " 861. giuliocomi/backoori\t\t\t\t1027. gitdurandal/dbd\n"
	echo "$SEP"
	echo "BLUETOOTH"
	...
	echo -ne " 918. virtualabs/btlejack\t919. conorpp/btproxy\t\t\t\t\t995. mikeryan/crackle\n"
	echo "$SEP"
	echo "BOT - AI"
	...
	echo -ne " 926. Konloch/bytecode-viewer\t\t\t1030. 0xd4d/de4dot\n"
	echo "$SEP"
	echo "DECRYPTING"
	...
	echo -ne " 1007. m8r0wn/crosslinked\t\t\t1033. SpiderLabs/deblaze\n"
	echo "$SEP"
	...
	echo -ne " 965. trycatchhcf/cloakify\t\t\t1036. nccgroup/demiguise\n"
	echo "$SEP"
	echo "EXCHANGE"
	...
	echo -ne " 986. patpadgett/corkscrew\t\t\t1010. chokepoint/CryptHook\n"
	echo "$SEP"
	echo "UPNP"
	...
	echo -ne " 109. cristiangonzales/Amazon-Discounts/proxy-list\t\t\t\t\t117. TheSpeedX/PROXY-List\n"
	echo -ne " 119. samrocketman/proxylist\t\t\t118. labic/ze-the-scraper/proxies-list\n"
	echo "$SEP"
	echo "?"
