...
while true; do
	...
	echo -ne " 1079. maxousc59/Blue-Sky-Information-Security\t\t\t\t1074. AeonDave/doork\n"
	echo "$SEP"
	echo "MITM"
	...
	echo -ne " 1056. Mr-Un1k0d3r/DKMC\t\t\t\t1073. TheWover/donut\n"
	echo "$SEP"
	echo "SHELLSHOCK"
