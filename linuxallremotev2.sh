...
while true; do
	...
	Stampa " 2597. DedSecInside/gotor"
	echo "$SEP"
	echo "GIT - REPOS"
	...
	Stampa " 2567. 0xFreddox/KeyLogger-WebService" "2596. Revise7/ViperVenom"
	echo "$SEP"
	echo "MEMCACHEDAEMON"
	...
	Stampa " 2544. EatonChips/wsh" "2599. oldkingcone/slopShell"
	echo "$SEP"
