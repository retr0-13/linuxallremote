...
while true; do
	...
	Stampa " 1285. HatBashBR/HatCloud"
	echo "$SEP"
	echo "EXCHANGE"
	...
	Stampa " 2555. junegunn/fzf" "1300. nccgroup/hodor"
	echo "$SEP"
	...
	Stampa " 1296. dstotijn/hetty" "2588. aufzayed/HydraRecon"
	echo "$SEP"
	echo "MITM - SNIFFING"
	...
	echo "$SEP"
	echo "PAYLOAD"
	Stampa " 1270. Rich5/Harness" "1295. EgeBalci/HERCULES"
	echo "$SEP"
	echo "PDF"
