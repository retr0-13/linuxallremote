...
while true; do
	...
	Stampa " 2512. geohot/qira" "2513. JonathanSalwan/ROPgadget"
	echo "$SEP"
	echo "ANDROID - APK"
	...
	Stampa " 2545. DivineSoftware/AutoRoot" "2566. 0x1CA3/AdbNet"
	echo "$SEP"
	echo "ANONYMIZATION"
	...
	Stampa " 827. Lab-Zjt/ARPTools" "828. ntrippar/ARPwner"
	echo "$SEP"
	echo "AWS"
	...
	Stampa " 1235. zombiesam/googlesub" "1269. hakluke/hakrevdns"
	echo "$SEP"
	echo "DOCKER"
	...
	Stampa " 1142. bwall/ExtractHosts" "1196. Nightbringer21/fridump"
	echo "$SEP"
	echo "EDITOR"
	...
	Stampa " 472. random-robbie/My-Shodan-Scripts" "473. woj-ciech/Kamerka-GUI" "474. m4ll0k/Shodanfy.py"
	...
	echo "$SEP"
	echo "HASH"
	Stampa " 2260. cube0x0/HashSpray.py" "2446. MichaelDim02/houndsniff"
	echo "$SEP"
	echo "HEAP"
	...
	Stampa " 2275. CrackerCat/evildll"
	echo "$SEP"
	echo "IKE"
	...
	echo "$SEP"
	echo "IoT"
	Stampa " 748. SafeBreach-Labs/SirepRAT"
	echo "$SEP"
	echo "IPCAM - DVR"
	...
	Stampa " 2485. EntySec/CamRaptor" "2486. AngelSecurityTeam/Cam-Hackers"
	echo "$SEP"
	echo "ISCSI"
	...
	Stampa " 2276. qtc-de/remote-method-guesser"
	echo "$SEP"
	echo "JENKINS"
	Stampa " 356. gquere/pwn_jenkins"
	echo "$SEP"
	echo "JOOMLA"
	Stampa " 2335. oppsec/juumla"
	echo "$SEP"
	echo "KERBEROS"
	...
	echo "$SEP"
	echo "MALWARE"
	Stampa " 407. avinashkranjan/Malware-with-Backdoor-and-Keylogger" "2567. 0xFreddox/KeyLogger-WebService"
	echo "$SEP"
	echo "MEMCACHEDAEMON"
	...
	Stampa " 1266. haka-security/haka"
	echo "$SEP"
	echo "MOBILE"
	...
	Stampa " 2447. octetsplicer/LAZYPARIAH" "2456. GetRektBoy724/MeterPwrShell"
	echo "$SEP"
	echo "RMI"
	...
	Stampa " 1191. stealth/fraud-bridge"
	echo "$SEP"
	echo "UPNP"
	...
	Stampa " 2556. Executione command line to Remote IP with RPC" "2557. Target IP" "2558. Target PORT"
	Stampa " 2559. Target Username" "2560. Target Password" "2561. Target Domain"
	Stampa " 2562. wordlist file" "2563. disassemble binary with objdump" "2564. display all binsry's headers with objdump"
	echo "$SEP"
	...
	Stampa " 2475. yehia-mamdouh/XSSYA-V-2.0"
	echo "$SEP"
	echo "ZIP"
	...
	Stampa " 1214. jeanphix/Ghost.py" "2471. sec-consult/aggrokatz"
	echo "$SEP"
	echo "GLOBAL VARIABLES"
	echo -e "Target: ""$TIP"":$TPRT|\tTarget domain: ""$TDOM""|\tTarget username: ""$TUSRN""|\tTarget password: ""$TPSSW""|\tWordlist: ""$WORDLIST"
	echo "$SEP"
